...
if __name__ == '__main__':
    ...
    ### CHANGE
    angle_loss_546_hybrid = np.loadtxt("results/546objv3/cos_sm_blk4_emb1024_reg6_drop6_histdata.txt") 
    angle_loss_546_cosine = np.loadtxt("results/CASE/546objv3/cos_sm/546objv3_cos_sm_histdata.txt")
    # angle_loss_82_hybrid = np.loadtxt("results/546objv3/cos_sm_blk4_emb1024_reg6_drop6_histdata.txt")
    # angle_loss_82_cosine = np.loadtxt("results/CASE/546objv3/cos_sm/546objv3_cos_sm_histdata.txt")
    ...
    plt.figure(figsize=(10,5))
    plt.bar(x_loc_546_hybrid, mean_losses_546_hybrid, yerr = errors_546_hybrid, width=width, label = "Unquantized")
    plt.bar(x_loc_546_cosine, mean_losses_546_cosine, yerr = errors_546_cosine, width=width, label = "Quantized")
